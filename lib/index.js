...
var ERROR_DEFAULT                   = 'An unspecified error occurred.';
...
function authorize(options) {
  var defaults = {
    ...
    fail:         function (data, message, critical, accept) {
      if (data.socketio_version_1) {
        accept(new PassportSocketIoError(message));
      } else {
        accept(null, false);
      }
    }
  ...
  if (!auth.cookieParser) {
    try {
      ...
      throw new PassportSocketIoError(ERROR_NO_COOKIE_PARSER);
    }
  }
...
function PassportSocketIoError (message) {
  this.name = 'PassportSocketIoError';
  this.message = message || ERROR_DEFAULT;
  this.stack = (new Error()).stack;
};

PassportSocketIoError.prototype = Object.create(Error.prototype);
PassportSocketIoError.prototype.constructor = PassportSocketIoError;

PassportSocketIoError.prototype.ERROR_DEFAULT                   = ERROR_DEFAULT;
PassportSocketIoError.prototype.ERROR_CORS_REQUEST              = ERROR_CORS_REQUEST;
PassportSocketIoError.prototype.ERROR_NO_COOKIE_PARSER          = ERROR_NO_COOKIE_PARSER;
PassportSocketIoError.prototype.ERROR_NO_SESSION                = ERROR_NO_SESSION;
PassportSocketIoError.prototype.ERROR_PASSPORT_NOT_INITIALIZED  = ERROR_PASSPORT_NOT_INITIALIZED;
PassportSocketIoError.prototype.ERROR_SESSION_STORE             = ERROR_SESSION_STORE;
PassportSocketIoError.prototype.ERROR_USER_NOT_AUTHORIZED       = ERROR_USER_NOT_AUTHORIZED;
PassportSocketIoError.prototype.ERROR_USER_NOT_FOUND            = ERROR_USER_NOT_FOUND;

exports.authorize = authorize;
exports.filterSocketsByUser = filterSocketsByUser;
exports.PassportSocketIoError = PassportSocketIoError;
